...
namespace Zeal\TestApi\Model\Api;

class TestApiManagement implements \Zeal\TestApi\Api\TestApiManagementInterface
{
    ...
    public function __construct(
        \Zeal\TestApi\Model\TestApiFactory $testApiFactory
